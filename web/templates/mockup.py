...
<body>
    ...
    <main class="main-content">
        <header class="page-header">
            <h2>ダッシュボード</h2>
            <p class="subtitle">箱をつなぐ → 管理画面でポチポチ → 最高の音</p>
        </header>

        <div class="status-grid">
            <div class="status-card ok">
                <div class="card-title">システムステータス</div>
                <div class="card-value">正常動作中</div>
                <div class="card-subtitle">GPU Engine Running</div>
            </div>

            <div class="status-card">
                <div class="card-title">現在の設定</div>
                <div class="card-value">Sony MDR-Z1R</div>
                <div class="card-subtitle">KB5000_7 Target Curve</div>
            </div>

            <div class="status-card">
                <div class="card-title">入力/出力</div>
                <div class="card-value">44.1kHz → 705.6kHz</div>
                <div class="card-subtitle">16x Upsampling (Minimum Phase)</div>
            </div>

            <div class="status-card ok">
                <div class="card-title">GPU処理</div>
                <div class="card-value">28x Realtime</div>
                <div class="card-subtitle">640k-tap FIR Convolution</div>
            </div>
        </div>
