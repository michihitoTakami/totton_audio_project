...
TRANSLATIONS = {
    "en": {
        ...
        "rtp.config.latency.stable": "Stable (200ms)",
        "rtp.config.latency.normal": "Normal (100ms)",
        "rtp.config.latency.realtime": "Real-time (50ms)",
        "rtp.config.latency.custom": "Custom",
        "rtp.config.save": "Save Configuration",
        "rtp.config.restart_note": "Note: Changing configuration will restart the daemon.",
    },
    "ja": {
        "app.title": "Magic Box",
        ...
        "rtp.config.latency.stable": "安定重視 (200ms)",
        "rtp.config.latency.normal": "通常 (100ms)",
        "rtp.config.latency.realtime": "リアルタイム重視 (50ms)",
        "rtp.config.latency.custom": "カスタム",
        "rtp.config.save": "設定を保存",
        "rtp.config.restart_note": "注意: 設定変更後はデーモンが再起動されます。",
    },
}
