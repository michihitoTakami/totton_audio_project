...
TRANSLATIONS = {
    "en": {
        ...
        "dashboard.phase_type.hybrid": "Hybrid Phase (≤150Hz min / >150Hz linear)",
        "dashboard.phase_type.info_minimum": "Full-band minimum phase processing (minimum latency)",
        "dashboard.phase_type.info_hybrid": "≤150Hz minimum phase, >150Hz linear phase (~6.7ms alignment)",
        "dashboard.phase_type.warning": "Hybrid phase adds ~6.7ms alignment delay and is not compatible with low latency mode.",
        # EQ section
        ...
        "eq.phase_type.hybrid": "Hybrid Phase (≤150Hz min / >150Hz linear)",
        "eq.phase_type.info_minimum": "Full-band minimum phase processing (minimum latency)",
        "eq.phase_type.info_hybrid": "≤150Hz minimum phase, >150Hz linear phase (~6.7ms alignment)",
    ...
    "ja": {
        ...
        "dashboard.phase_type.hybrid": "Hybrid Phase (150Hz以下最小 / 150Hz以上線形)",
        "dashboard.phase_type.info_minimum": "全帯域を最小位相で処理（最小レイテンシ）",
        "dashboard.phase_type.info_hybrid": "150Hz以下は最小位相、150Hz以上は線形位相（約6.7ms整列）で処理",
        "dashboard.phase_type.warning": "⚠️ ハイブリッド位相は約6.7msの整列ディレイが発生し、低遅延モードとは併用できません。",
        # EQ section
        ...
        "eq.phase_type.hybrid": "Hybrid Phase (150Hz以下最小 / 150Hz以上線形)",
        "eq.phase_type.info_minimum": "全帯域を最小位相で処理（最小レイテンシ）",
        "eq.phase_type.info_hybrid": "150Hz以下は最小位相、150Hz以上は線形位相（約6.7ms整列）で処理",
