...
def analyze_frequency_response(input_file, output_file, output_plot=None):
    ...
    axes[1].axvline(20, color='g', linestyle='--', alpha=0.5, label='Passband edge (20 kHz)')
    axes[1].axvline(22.05, color='orange', linestyle='--', alpha=0.5, label='Stopband start (22.05 kHz)')
    ...
    if output_plot:
        ...
        print(f"Plot saved: plots/analysis/frequency_verification.png")
