...
void launch_precision_rocFFT_double(void* inputC, void* output_rocFFT, int device_id,
                                    uint64_t* dims) {
    ...
    hipMemcpy(output_rocFFT, dataC, sizeof(hipfftDoubleComplex) * dims[0] * dims[1] * dims[2],
