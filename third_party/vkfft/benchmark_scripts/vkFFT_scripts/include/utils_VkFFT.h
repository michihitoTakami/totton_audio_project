...
typedef struct {
    ...
    VkPhysicalDeviceMemoryProperties
        physicalDeviceMemoryProperties;       // bastic memory properties of the device
    ...
    VkDeviceMemory* stagingBufferMemory;  // optional pointer to the user defined staging buffer
                                          // memory, associated with the stagingBuffer
...
} VkFFTUserSystemParameters;  // an example structure used to pass user-defined system for
                              // benchmarking
