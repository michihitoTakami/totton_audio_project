...
VkFFTResult sample_5_benchmark_VkFFT_single_disableReorderFourStep(VkGPU* vkGPU,
                                                                   uint64_t file_output,
                                                                   FILE* output,
    ...
    if (file_output)
        fprintf(
            output,
            "5 - VkFFT FFT + iFFT C2C benchmark 1D batched in single precision, no reshuffling\n");
