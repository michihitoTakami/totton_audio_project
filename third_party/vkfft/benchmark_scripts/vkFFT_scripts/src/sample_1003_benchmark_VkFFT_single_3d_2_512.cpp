...
VkFFTResult sample_1003_benchmark_VkFFT_single_3d_2_512(VkGPU* vkGPU, uint64_t file_output,
    ...
    if (file_output)
        fprintf(output,
                "1003 - VkFFT FFT + iFFT C2C multidimensional benchmark in single precision: all "
                "supported cubes from 2 to 512\n");
    printf(
        "1003 - VkFFT FFT + iFFT C2C multidimensional benchmark in single precision: all supported "
        "cubes from 2 to 512\n");
