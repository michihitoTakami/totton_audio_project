...
VkFFTResult launchVkFFT(VkGPU* vkGPU, uint64_t sample_id, bool file_output, FILE* output,
    ...
    for (uint64_t j = 0; j < numDrivers; j++) {
        ...
        for (uint64_t i = 0; i < numDevices; i++) {
            if (k == vkGPU->device_id) {
                ...
                res = zeCommandQueueCreate(vkGPU->context, vkGPU->device, &commandQueueDescription,
                                           &vkGPU->commandQueue);
                if (res != ZE_RESULT_SUCCESS)
                    return VKFFT_ERROR_FAILED_TO_CREATE_COMMAND_QUEUE;
    ...
    case 3: {
        resFFT =
            sample_3_benchmark_VkFFT_single_3d(vkGPU, file_output, output, isCompilerInitialized);
        break;
    }
    case 4: {
        resFFT = sample_4_benchmark_VkFFT_single_3d_zeropadding(vkGPU, file_output, output,
                                                                isCompilerInitialized);
        break;
    }
    case 5: {
        resFFT = sample_5_benchmark_VkFFT_single_disableReorderFourStep(vkGPU, file_output, output,
                                                                        isCompilerInitialized);
        break;
    }
    case 6: {
        resFFT =
            sample_6_benchmark_VkFFT_single_r2c(vkGPU, file_output, output, isCompilerInitialized);
        break;
    }
    case 7: {
        resFFT = sample_7_benchmark_VkFFT_single_Bluestein(vkGPU, file_output, output,
                                                           isCompilerInitialized);
        break;
    }
    case 8: {
        resFFT = sample_8_benchmark_VkFFT_double_Bluestein(vkGPU, file_output, output,
                                                           isCompilerInitialized);
        break;
    }
#ifdef VKFFT_USE_DOUBLEDOUBLE_FP128
    case 9: {
        resFFT = sample_9_benchmark_VkFFT_quadDoubleDouble(vkGPU, file_output, output,
                                                           isCompilerInitialized);
        break;
    }
#endif
#if (VKFFT_BACKEND == 0)
    case 10: {
        resFFT = sample_10_benchmark_VkFFT_single_multipleBuffers(vkGPU, file_output, output,
                                                                  isCompilerInitialized);
        break;
    }
#endif
    ...
    case 11: {
        resFFT =
            sample_11_precision_VkFFT_single(vkGPU, file_output, output, isCompilerInitialized);
        break;
    }
    case 12: {
        resFFT =
            sample_12_precision_VkFFT_double(vkGPU, file_output, output, isCompilerInitialized);
        break;
    }
    case 13: {
    ...
    case 14: {
        resFFT = sample_14_precision_VkFFT_single_nonPow2(vkGPU, file_output, output,
                                                          isCompilerInitialized);
        break;
    }
    case 15: {
        resFFT =
            sample_15_precision_VkFFT_single_r2c(vkGPU, file_output, output, isCompilerInitialized);
        break;
    }
    case 16: {
        resFFT =
            sample_16_precision_VkFFT_single_dct(vkGPU, file_output, output, isCompilerInitialized);
        break;
    }
    case 17: {
        resFFT =
            sample_17_precision_VkFFT_double_dct(vkGPU, file_output, output, isCompilerInitialized);
        break;
    }
    case 18: {
        resFFT = sample_18_precision_VkFFT_double_nonPow2(vkGPU, file_output, output,
                                                          isCompilerInitialized);
        break;
    }
#ifdef VKFFT_USE_DOUBLEDOUBLE_FP128
    case 19: {
        resFFT = sample_19_precision_VkFFT_quadDoubleDouble_nonPow2(vkGPU, file_output, output,
                                                                    isCompilerInitialized);
        break;
    }
#endif
#endif
    case 50: {
        resFFT = sample_50_convolution_VkFFT_single_1d_matrix(vkGPU, file_output, output,
                                                              isCompilerInitialized);
        break;
    }
    case 51: {
        resFFT = sample_51_convolution_VkFFT_single_3d_matrix_zeropadding_r2c(
            vkGPU, file_output, output, isCompilerInitialized);
        break;
    }
    case 52: {
        resFFT = sample_52_convolution_VkFFT_single_2d_batched_r2c(vkGPU, file_output, output,
                                                                   isCompilerInitialized);
        break;
    }
    case 110: {
        resFFT = sample_100_benchmark_VkFFT_single_nd_dct(vkGPU, file_output, output,
                                                          isCompilerInitialized, 1);
        break;
    }
    case 120: {
        resFFT = sample_100_benchmark_VkFFT_single_nd_dct(vkGPU, file_output, output,
                                                          isCompilerInitialized, 2);
        break;
    }
    case 130: {
        resFFT = sample_100_benchmark_VkFFT_single_nd_dct(vkGPU, file_output, output,
                                                          isCompilerInitialized, 3);
        break;
    }
    case 140: {
        resFFT = sample_100_benchmark_VkFFT_single_nd_dct(vkGPU, file_output, output,
                                                          isCompilerInitialized, 4);
        break;
    }
    case 111: {
        resFFT = sample_101_benchmark_VkFFT_double_nd_dct(vkGPU, file_output, output,
                                                          isCompilerInitialized, 1);
        break;
    }
    case 121: {
    ...
    case 202: {
        resFFT =
            user_benchmark_VkFFT(vkGPU, file_output, output, isCompilerInitialized, userParams);
        break;
    }
#ifdef VKFFT_USE_DOUBLEDOUBLE_FP128
    case 203: {
...
#endif
    case 1000: {
        resFFT = sample_1000_benchmark_VkFFT_single_2_4096(vkGPU, file_output, output,
                                                           isCompilerInitialized);
        break;
    }
    case 1001: {
        resFFT = sample_1001_benchmark_VkFFT_double_2_4096(vkGPU, file_output, output,
                                                           isCompilerInitialized);
        break;
    }
    case 1002: {
        resFFT = sample_1002_benchmark_VkFFT_half_2_4096(vkGPU, file_output, output,
                                                         isCompilerInitialized);
        break;
    }
    case 1003: {
        resFFT = sample_1003_benchmark_VkFFT_single_3d_2_512(vkGPU, file_output, output,
                                                             isCompilerInitialized);
        break;
    }
#ifdef VKFFT_USE_DOUBLEDOUBLE_FP128
    case 1004: {
        resFFT = sample_1004_benchmark_VkFFT_quadDoubleDouble_2_4096(vkGPU, file_output, output,
                                                                     isCompilerInitialized);
        break;
    }
#endif
...
int main(int argc, char* argv[]) {
    ...
    if (findFlag(argv, argv + argc, "-h")) {
        ...
        version_decomposed[2] =
            (version - version_decomposed[0] * 10000 - version_decomposed[1] * 100);
        printf("VkFFT v%d.%d.%d (05-02-2024). Author: Tolmachev Dmitrii\n", version_decomposed[0],
               version_decomposed[1], version_decomposed[2]);
#if (VKFFT_BACKEND == 0)
        ...
        printf(
            "		4 - FFT + iFFT C2C multidimensional benchmark in single precision, native "
            "zeropadding\n");
        printf(
...
#ifdef VKFFT_USE_DOUBLEDOUBLE_FP128
        printf(
            "		9 - FFT + iFFT C2C benchmark 1D batched in double-double emulation of quad "
            "precision LUT\n");
#endif
#if (VKFFT_BACKEND == 0)
        ...
        printf(
            "		14 - VkFFT / FFTW C2C radix 3 / 5 / 7 / 11 / 13 / Bluestein precision test in "
            "single precision\n");
        printf("		15 - VkFFT / cuFFT / FFTW R2C+C2R precision test in single precision\n");
        printf(
            "		16 - VkFFT / FFTW R2R DCT-I, II, III and IV precision test in single "
            "precision\n");
        printf(
            "		17 - VkFFT / FFTW R2R DCT-I, II, III and IV precision test in double "
            "precision\n");
        printf(
            "		18 - VkFFT / FFTW C2C radix 3 / 5 / 7 / 11 / 13 / Bluestein precision test in "
            "double precision\n");
#ifdef VKFFT_USE_DOUBLEDOUBLE_FP128
        printf(
            "		19 - VkFFT / FFTW C2C precision test in double-double emulation of quad "
            "precision\n");
#endif
#elif USE_rocFFT
        ...
        printf(
            "		110 - VkFFT FFT + iFFT R2R DCT-1 multidimensional benchmark in single "
            "precision\n");
        printf(
            "		111 - VkFFT FFT + iFFT R2R DCT-1 multidimensional benchmark in double "
            "precision\n");
        printf(
            "		120 - VkFFT FFT + iFFT R2R DCT-2 multidimensional benchmark in single "
            "precision\n");
        printf(
            "		121 - VkFFT FFT + iFFT R2R DCT-2 multidimensional benchmark in double "
            "precision\n");
        printf(
            "		130 - VkFFT FFT + iFFT R2R DCT-3 multidimensional benchmark in single "
            "precision\n");
        printf(
            "		131 - VkFFT FFT + iFFT R2R DCT-3 multidimensional benchmark in double "
            "precision\n");
        printf(
            "		140 - VkFFT FFT + iFFT R2R DCT-4 multidimensional benchmark in single "
            "precision\n");
        printf(
            "		141 - VkFFT FFT + iFFT R2R DCT-4 multidimensional benchmark in double "
            "precision\n");

        printf(
            "		1000 - FFT + iFFT C2C benchmark 1D batched in single precision: all supported "
            "systems from 2 to 4096\n");
        printf(
            "		1001 - FFT + iFFT C2C benchmark 1D batched in double precision: all supported "
            "systems from 2 to 4096\n");
        printf(
            "		1002 - FFT + iFFT C2C benchmark 1D batched in half precision: all supported "
            "systems from 2 to 4096\n");
        printf(
            "		1003 - FFT + iFFT C2C multidimensional benchmark in single precision: all "
            "supported cubes from 2 to 512\n");
#ifdef VKFFT_USE_DOUBLEDOUBLE_FP128
        printf(
            "		1004 - FFT + iFFT C2C benchmark 1D batched in double-double emulation of quad "
            "precision: all supported systems from 2 to 4096\n");
#endif
        printf(
            "	-benchmark_vkfft: run VkFFT benchmark on a user-defined system:\n\
        ...
        printf("		6 - FFT + iFFT R2C / C2R benchmark\n");
        printf(
            "		7 - FFT + iFFT C2C big prime benchmark in single precision (similar to VkFFT "
            "Bluestein)\n");
        printf(
            "		8 - FFT + iFFT C2C big prime benchmark in double precision (similar to VkFFT "
            "Bluestein)\n");
        printf(
            "		1000 - FFT + iFFT C2C benchmark 1D batched in single precision: all supported "
            "systems from 2 to 4096\n");
        ...
        printf(
            ...
            "supported cubes from 2 to 512\n");
        printf(
            "	-test: (or no -vkfft and -cufft keys) run vkfft benchmarks 0-6 and cufft "
            "benchmarks 0-6\n");
        printf(
            "	-benchmark_cufft: run cuFFT benchmark on a user-defined system:\n\
		-X uint, -Y uint, -Z uint - FFT dimensions (default Y and Z are 1)\n\
        ...
        printf(
            ...
            "supported cubes from 2 to 512\n");
        printf(
            "	-test: (or no -vkfft and -rocfft keys) run vkfft benchmarks 0-6 and rocfft "
            "benchmarks 0-6\n");
        printf(
            "	-benchmark_rocfft: run rocFFT benchmark on a user-defined system:\n\
		-X uint, -Y uint, -Z uint - FFT dimensions (default Y and Z are 1)\n\
		-P uint - precision (0 - single, 1 - double) (default 0)\n\
		-B uint - number of batched systems (default 1)\n\
		-N uint - number of consecutive FFT+iFFT iterations (default 1)\n\
    ...
    if (findFlag(argv, argv + argc, "-benchmark_vkfft") ||
        findFlag(argv, argv + argc, "-benchmark_cufft") ||
        findFlag(argv, argv + argc, "-benchmark_rocfft")) {
        // select sample_id
        VkFFTUserSystemParameters userParams = {};
        userParams.X = 1;
        userParams.Y = 1;
        ...
        if (findFlag(argv, argv + argc, "-benchmark_vkfft")) {
            VkFFTResult resFFT =
                launchVkFFT(&vkGPU, 200 + userParams.P, file_output, output, &userParams);
            ...
            if (findFlag(argv, argv + argc, "-benchmark_rocfft")) {
                user_benchmark_rocFFT(file_output, output,
                                      (rocFFTUserSystemParameters*)(&userParams),
                                      (int)vkGPU.device_id);
            }
            return 0;
#endif
...
#endif
    if ((findFlag(argv, argv + argc, "-test")) ||
        ((!findFlag(argv, argv + argc, "-cufft")) && (!findFlag(argv, argv + argc, "-rocfft")) &&
         (!findFlag(argv, argv + argc, "-vkfft")))) {
        if (output == NULL) {
            file_output = true;
