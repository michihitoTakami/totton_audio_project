...
class ArgumentEncoder : public NS::Referencing<ArgumentEncoder> {
   public:
    ...
    void setArgumentBuffer(const class Buffer* argumentBuffer, NS::UInteger startOffset,
    ...
    void setIndirectCommandBuffer(const class IndirectCommandBuffer* indirectCommandBuffer,
                                  NS::UInteger index);
    ...
    void setVisibleFunctionTables(const VisibleFunctionTable* visibleFunctionTables[],
                                  NS::Range range);

    void setIntersectionFunctionTable(
        const class IntersectionFunctionTable* intersectionFunctionTable, NS::UInteger index);

    void setIntersectionFunctionTables(
        const IntersectionFunctionTable* intersectionFunctionTables[], NS::Range range);
};
...
_MTL_INLINE void MTL::ArgumentEncoder::setBuffers(MTL::Buffer* buffers[],
...
_MTL_INLINE void MTL::ArgumentEncoder::setSamplerStates(MTL::SamplerState* samplers[],
                                                        NS::Range range) {
...
_MTL_INLINE void MTL::ArgumentEncoder::setRenderPipelineStates(MTL::RenderPipelineState* pipelines,
                                                               NS::Range range) {
...
_MTL_INLINE void MTL::ArgumentEncoder::setComputePipelineStates(
    MTL::ComputePipelineState* pipelines, NS::Range range) {
    Object::sendMessage<void>(this, _MTL_PRIVATE_SEL(setComputePipelineStates_withRange_),
                              pipelines, range);
}
...
_MTL_INLINE void MTL::ArgumentEncoder::setIndirectCommandBuffers(
    MTL::IndirectCommandBuffer* buffers, NS::Range range) {
