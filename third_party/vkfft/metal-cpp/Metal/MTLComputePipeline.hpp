...
class ComputePipelineState : public NS::Referencing<ComputePipelineState> {
   public:
    ...
    class ComputePipelineState* newComputePipelineState(const NS::Array* functions,
                                                        NS::Error** error);
...
_MTL_INLINE void MTL::ComputePipelineDescriptor::setStageInputDescriptor(
    ...
    Object::sendMessage<void>(this, _MTL_PRIVATE_SEL(setStageInputDescriptor_),
