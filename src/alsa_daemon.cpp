...
// This file must stay a tiny entrypoint (main()) only.
//
// If you need new behavior (ALSA/control/pipeline/stats/threads/etc),
// implement it in `src/daemon/**` (and corresponding `include/daemon/**`)
// and wire it through `daemon_app::App`.
