...
inline constexpr FilterPreset FILTER_PRESET_44K = {
    ...
    "2M-tap hybrid FIR (≤150 Hz min-phase, >150 Hz ~6.7 ms linear) for 44.1kHz → 705.6kHz (16x)",
    2'000'000};

inline constexpr FilterPreset FILTER_PRESET_48K = {
    48000, 16, "data/coefficients/filter_48k_16x_2m_hybrid_phase.bin",
    "2M-tap hybrid FIR (≤150 Hz min-phase, >150 Hz ~6.7 ms linear) for 48kHz → 768kHz (16x)",
    2'000'000};
