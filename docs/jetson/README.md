# Totton Audio - Jetson Orin Nano 組み込みガイド
...
Totton Audioは、640,000タップの最小位相FIRフィルタによる究極のアップサンプリングと、ヘッドホン周波数特性の自動補正を提供するオーディオプロセッサです。

### 主要機能

| 機能 | 説明 |
|------|------|
| **Ultimate Upsampling** | 640kタップ最小位相FIRで最大16倍アップサンプリング（44.1kHz→705.6kHz） |
...
```
PC  ──USB Type-C──>  Totton Audio  ──USB Type-A──>  外部DAC  ──>  ヘッドホン
```
